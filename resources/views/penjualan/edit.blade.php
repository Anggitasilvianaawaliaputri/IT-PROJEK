...
<div class="container">
    ...
    <form action="{{ route('penjualan.update', $transaction->id) }}" method="POST"> <!-- Rute diubah ke penjualan.update -->
        ...
        <div class="form-group">
            ...
            <input type="number" name="netto" class="form-control" value="{{ $transaction->netto }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="satuan" id="satuan" class="form-select" required>
                <option value="Kg" {{ $transaction->satuan == 'Kg' ? 'selected' : '' }}>Kg</option>
                <option value="Gram" {{ $transaction->satuan == 'Gram' ? 'selected' : '' }}>Gram</option>
                <option value="Liter" {{ $transaction->satuan == 'Liter' ? 'selected' : '' }}>Liter</option>
                <option value="Pcs" {{ $transaction->satuan == 'Pcs' ? 'selected' : '' }}>Pcs</option>
                <option value="Lainnya" {{ $transaction->satuan == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
            </select>
        </div>
